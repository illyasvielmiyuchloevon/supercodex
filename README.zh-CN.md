...
普通文本会作为 Codex session 中的普通指令原文发送。它不会创建 `.supercodex/FINAL_GOAL.md`，不会注入 SuperCodex 的 External Supervisor Prompt，也不会启动 PRD / 架构 / PLAN / Phase 6 / Phase 7 交付循环。
...
- 启动 PRD / 架构 / PLAN / Phase 6 / Phase 7 交付循环。
